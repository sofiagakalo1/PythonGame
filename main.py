...
player_rect = player.get_rect(center=(100, 380))
...
def create_bonus():
    ...
    bonus_rect = pygame.Rect(random.randint(0, WIDTH-100), -bonus.get_height(), *bonus.get_size())
...
# якщо bg1 менше за ширину картинки, то ми ставимо bg1 в початок картинки
    if bg_X1 < -bg.get_width():
        bg_X1 = bg.get_width()
# якщо bg2 менше за ширину картинки, то ми ставимо bg2 в початок картинки
